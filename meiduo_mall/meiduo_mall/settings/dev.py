...
SECRET_KEY = '_30c!q15pp$)i3f^w6x^aa@h1pxxh_n(+89v$wb)b9tc%bv0+1'
...
CRONJOBS = [
    # 每1分钟生成一次首页静态文件
    ('*/1 * * * *', 'Users.august.Desktop.python45.meiduo.meiduo_mall.meiduo_mall.utils.static_html.get_index_static', '>> ' + os.path.join(os.path.dirname(BASE_DIR), 'logs/crontab.log'))
]
